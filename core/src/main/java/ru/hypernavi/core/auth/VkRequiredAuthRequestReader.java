 ...
 */
public class VkRequiredAuthRequestReader extends VkAuthRequestReader {
    ...
    public VkRequiredAuthRequestReader(@NotNull final HttpServletRequest req) {
        super(req);
    }
    ...
    public void validate(@NotNull final Session session) throws SessionValidationException {
        ...
        if (getParamUser() != null && PARAM_HASH.contained(req)) {
            ...
            for (final Cookie cookie : cookies) {
                ...
                cookie.setMaxAge((int) LocalDateTime.now().plus(2, ChronoUnit.YEARS).toEpochSecond(ZoneOffset.UTC));
            }
