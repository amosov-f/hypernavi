 ...
 */
@WebServlet(name = "remove site", value = "/admin/site/remove", loadOnStartup = 0)
public class RemoveSiteAdminService extends SiteAdminService {
